...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \begin{minipage}{0.75\textwidth}
    \textbf{\Large 김솔지} \\[4pt]
    \href{https://github.com/so1gging}{Github} $|$ 
    \href{https://www.linkedin.com/in/solzykim/}{LinkedIn} \\
    Email : \href{mailto:yzlosmik@gmail.com}{yzlosmik@gmail.com} \\
    Mobile : (+82) 010-4854-7484
  \end{minipage}
  &
    \begin{minipage}{0.2\textwidth}
      \centering
      \circlepic{profile.jpeg}
    \end{minipage}
\end{tabular*}
...
\par
\projectDescription{
상업용 부동산 실거래 데이터를 기반으로 지표 분석과 인사이트 제공을 위한 웹 서비스
}
\resumeItemListStart
  ...
  \resumeItem{수동으로 운영되던 QA 체크리스트를 E2E 테스트로 자동화하여 배포 안정성 향상 기여}
\resumeItemListEnd
...
\par
\projectDescription{
사내 운영 및 데이터 관리를 위한 관리자용 백오피스 웹 서비스
}
\resumeItemListStart
    ...
    \resumeItem{기존 \textbf{Cypress 기반 E2E 테스트를 Playwright로 마이그레이션}하여 테스트 속도 \textbf{70\% 이상} 개선}
\resumeItemListEnd
...
\par
\projectDescription{
사내 다수의 웹·앱 프로젝트에 대한 기능 개발 및 유지보수 업무 수행
}
\resumeItemListStart
